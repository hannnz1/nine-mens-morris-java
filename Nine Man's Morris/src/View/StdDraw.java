package View; /******************************************************************************
 *  Compilation:  javac org.example.View.StdDraw.java
 *  Execution:    java org.example.View.StdDraw
 *  Dependencies: none
 *
...
/**
 *  <p><b>Overview.</b>
 *  The {@code org.example.View.StdDraw} class provides a basic capability for
 *  creating drawings with your programs. It uses a simple graphics model that
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use this class, you must have {@code org.example.View.StdDraw.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, either download
 *  <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 *  and add to your Java classpath or download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdDraw.java">org.example.View.StdDraw.java</a>
 ...
 *           org.example.View.StdDraw.setPenRadius(0.05);
 *           org.example.View.StdDraw.setPenColor(org.example.View.StdDraw.BLUE);
 *           org.example.View.StdDraw.point(0.5, 0.5);
 *           org.example.View.StdDraw.setPenColor(org.example.View.StdDraw.MAGENTA);
 *           org.example.View.StdDraw.line(0.2, 0.2, 0.8, 0.2);
 *       }
 *   }
 *  </pre>
 ...
 *  The methods {@code org.example.View.StdDraw.line()} and {@code org.example.View.StdDraw.point()}
 *  draw lines and points; the methods {@code org.example.View.StdDraw.setPenRadius()}
 *  and {@code org.example.View.StdDraw.setPenColor()} control the line thickness and color.
 *  <p>
 ...
 *  and represented in degrees. For example, {@code org.example.View.StdDraw.arc(0.0, 0.0, 1.0, 0, 90)}
 ...
 *   org.example.View.StdDraw.filledPolygon(x, y);
 *  </pre>
 *  <p>
 *  <b>Pen size.</b>
 ...
 *  </ul>
 *  <p>
 *  For example, {@code org.example.View.StdDraw.setPenRadius(0.025)} makes
 ...
 *  For example, {@code org.example.View.StdDraw.setPenColor(org.example.View.StdDraw.MAGENTA)} sets the
 ...
 *  For example, {@code org.example.View.StdDraw.setCanvasSize(800, 800)}
 ...
 *  leave a small margin, you can call {@code org.example.View.StdDraw.setScale(-.05, 1.05)}.
 *  <p>
 ...
 *   org.example.View.StdDraw.setFont(font);
 *   org.example.View.StdDraw.text(0.5, 0.5, "Hello, World");
 *  </pre>
 *  <p>
 *  <b>Images.</b>
 ...
 *  {@code org.example.View.StdDraw.clear(org.example.View.StdDraw.LIGHT_GRAY)} clears the canvas to a shade
 *  of gray.
 *  <p>
 ...
 *  <pre>
 *   org.example.View.StdDraw.setScale(-2, +2);
 *   org.example.View.StdDraw.enableDoubleBuffering();
 *
 *   for (double t = 0.0; true; t += 0.02) {
 *       double x = Math.sin(t);
 *       double y = Math.cos(t);
 *       org.example.View.StdDraw.clear();
 *       org.example.View.StdDraw.filledCircle(x, y, 0.05);
 *       org.example.View.StdDraw.filledCircle(-x, -y, 0.05);
 *       org.example.View.StdDraw.show();
 *       org.example.View.StdDraw.pause(20);
 *   }
 *  </pre>
 *  <p>
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    ***************************************************************************/
     ...
     * {@code org.example.View.StdDraw.BLACK}, {@code org.example.View.StdDraw.BLUE}, {@code org.example.View.StdDraw.CYAN},
     * {@code org.example.View.StdDraw.DARK_GRAY}, {@code org.example.View.StdDraw.GRAY}, {@code org.example.View.StdDraw.GREEN},
     * {@code org.example.View.StdDraw.LIGHT_GRAY}, {@code org.example.View.StdDraw.MAGENTA}, {@code org.example.View.StdDraw.ORANGE},
     * {@code org.example.View.StdDraw.PINK}, {@code org.example.View.StdDraw.RED}, {@code org.example.View.StdDraw.WHITE}, and
     * {@code org.example.View.StdDraw.YELLOW}.
     *
    ...
    ***************************************************************************/
    ...
    private static Image getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to org.example.View.StdDraw)
        if (icon.getImageLoadStatus() != MediaTracker.COMPLETE) {
...
/*
    private static BufferedImage getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to org.example.View.StdDraw)
        try {
            URL url = org.example.View.StdDraw.class.getResource(filename);
            BufferedImage image = ImageIO.read(url);
            return image;
        }
        catch (IOException e) {
